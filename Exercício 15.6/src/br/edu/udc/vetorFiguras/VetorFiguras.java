...
class Painel extends JPanel {
	...
	public void paint(Graphics g) {
		...
		for(int i = 0; i < numFig; i++) {
			/* 1 = Circulo */
			if (f[i].getTipo() == 1)
				g.drawOval((int)f[i].getOrigem().getX(), (int)f[i].getOrigem().getY(), (int)f[i].getFim().getX(), (int)f[i].getFim().getY());
			
			/* 2 = Retangulo */
			else if (f[i].getTipo() == 2)
				g.drawRect((int)f[i].getOrigem().getX(), (int)f[i].getOrigem().getY(), (int)f[i].getFim().getX(), (int)f[i].getFim().getY());
			
			/* 3 = Ponto */
			else if (f[i].getTipo() == 3)
				g.fillOval((int)f[i].getOrigem().getX(), (int)f[i].getOrigem().getY(), (int)f[i].getFim().getX(), (int)f[i].getFim().getY());
			
			/* 4 = Linha */
			else if (f[i].getTipo() == 4)
				g.drawLine((int)f[i].getOrigem().getX(),(int)f[i].getOrigem().getY(), (int)f[i].getFim().getX(), (int)f[i].getFim().getY());
