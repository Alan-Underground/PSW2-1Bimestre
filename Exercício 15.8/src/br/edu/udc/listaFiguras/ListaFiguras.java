...
class Painel extends JPanel {
	...
	public void paint(Graphics g) {
		...
		for(Figura p:f) {
			...
			/* 1 = Circulo */
			if (i.getTipo() == 1) {
				g.drawOval((int)i.getOrigem().getX(), (int)i.getOrigem().getY(), (int)i.getFim().getX(), (int)i.getFim().getY());
			...
			/* 2 = Retangulo */
				...
				g.drawRect((int)i.getOrigem().getX(), (int)i.getOrigem().getY(), (int)i.getFim().getX(), (int)i.getFim().getY());
			
			}
			
			/* 3 = Ponto */
			else if (i.getTipo() == 3) {
				g.fillOval((int)i.getOrigem().getX(), (int)i.getOrigem().getY(), (int)i.getFim().getX(), (int)i.getFim().getY());
			
			}
			
			/* 4 = Linha */
			else if (i.getTipo() == 4) {
				g.drawLine((int)i.getOrigem().getX(), (int)i.getOrigem().getY(), (int)i.getFim().getX(), (int)i.getFim().getY());
